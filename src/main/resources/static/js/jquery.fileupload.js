...
(function (factory) {
    ...
    $.widget('blueimp.fileupload', {
        ...
        _getParamName: function (options) {
            let fileInput = $(options.fileInput),
        ...
        _getAJAXSettings: function (data) {
            let options = $.extend({}, this.options, data);
        ...
        _getUploadedBytes: function (jqXHR) {
            let range = jqXHR.getResponseHeader('Range'),
        ...
        _onDone: function (result, textStatus, jqXHR, options) {
            let total = options._progress.total;
        ...
        _replaceFileInput: function (input) {
            let inputClone = input.clone(true);
        ...
        _getSingleFileInputFiles: function (fileInput) {
            fileInput = $(fileInput);
            let entries = fileInput.prop('webkitEntries') ||
        ...
        _setOption: function (key, value) {
            let refresh = $.inArray(key, this._refreshOptionsList) !== -1;
            if (refresh) {
