...
( function ( $ ) {
	...
	let noResultsTemplate, LanguageCategoryDisplay;
	...
	LanguageCategoryDisplay.prototype = {
		...
		addToRegion: function ( langCode, region ) {
			let i, regionCode, $li, $column, lastLanguage, lastScriptGroup, currentScriptGroup,
				lcd = this,
		...
		quicklist: function () {
			let quickList, $quickListSection, $quickListSectionTitle, i,
		...
		noResults: function () {
			this.$noResults.show();
			let $suggestions = this.quicklist();
			$suggestions.find( 'h3' )
