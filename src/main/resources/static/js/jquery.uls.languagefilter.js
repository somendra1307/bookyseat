...
(function ( $ ) {
	...
	LanguageFilter.prototype = {
		...
		keyup: function( e ) {
			let suggestion, query, languageFilter;
		...
		filter: function( langCode, searchTerm ) {
			...
			let matcher = new RegExp( '^' + this.escapeRegex( searchTerm ), 'i' ),
	...
	function isVisualPrefix( prefix, string ) {
		...
		let prebases = 'െേൈൊോൌெேைொோௌେୈୋୌિਿिিেৈোৌෙේෛොෝෞ';
