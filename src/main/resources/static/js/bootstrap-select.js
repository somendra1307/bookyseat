...
(function ($) {
  ...
  $.expr[':'].icontains = function (obj, index, meta) {
    let $obj = $(obj);
    let haystack = ($obj.data('tokens') || $obj.text()).toUpperCase();
  ...
  $.expr[':'].aicontains = function (obj, index, meta) {
    let $obj = $(obj);
    let haystack = ($obj.data('tokens') || $obj.data('normalizedText') || $obj.text()).toUpperCase();
    return haystack.includes(meta[3].toUpperCase());
  };
  ...
  let Selectpicker = function (element, options, e) {
    if (e) {
      e.stopPropagation();
      e.preventDefault();
    }
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      let multiple = this.multiple ? ' show-tick' : '',
    ...
    createLi: function () {
       ...
       * @returns {string}
       */
      let generateLI = function (content, index, classes, optgroup) {
        return '<li' +
       ...
       * @returns {string}
       */
      let generateA = function (text, classes, inline, tokens) {
        return '<a tabindex="0"' +
      ...
      this.$element.find('option').each(function (index) {
        ...
        if (this.parentNode.tagName === 'OPTGROUP' && $this.data('divider') !== true) {
          let optGroupClass = ' ' + this.parentNode.className || '';
  ...
  function Plugin(option, event) {
    ...
    let chain = this.each(function () {
      ...
      if ($this.is('select')) {
        ...
        if (!data) {
          let config = $.extend({}, Selectpicker.DEFAULTS, $.fn.selectpicker.defaults || {}, $this.data(), options);
